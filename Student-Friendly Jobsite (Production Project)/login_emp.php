...
if(isset($_POST['submit'])){  
    ...
    $detail = "SELECT * FROM users WHERE user_email = '$user_email' AND user_password = '$pass' AND user_type = 'Employer'";
      ...
      if($detailqry->num_rows !=0){
        if($active==1){ 
          ...
          if(strtoupper($type)=="EMPLOYER"){
            ...
            <p style='text:justify; text-align: center; color:red;'>Invalid login credentialss !</p>
          </div><br/><br/><br/>";    
        }
      }
     
      else{
        $error = "<div class='col-md-12 col-sm-12 col-md-offset-0 col-sm-offset-2' style='background-color:#ffdbdd; height:80px; border-style:round; border: 2px;
        border-radius: 5px; '>
        <p style='text:justify; text-align: center; color:red;'>Your Account Is Not Active. Please Contact your Administrator at jobstudents31@gmail.com !</p>
        </div><br/><br/><br/><br/>   ";       
      }
  }
  else{  

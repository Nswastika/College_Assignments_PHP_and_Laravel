...
$startdate = $_POST['startdate9'];
$enddate = $_POST['enddate9'];
    ...
    <section class="pricind">
			<div class="container">
                <div class ="col-md-12 col-sm-12">
                    <form action="create_resume_job.php" method="post">
                        <h5>Personal Information</h1>
                            ...
                            <h5>Most Recent Job</h1>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">Job Title</label>
                                <input type="text"  class="form-control input-lg" name="jobtitle" required>
                            </div>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">Employer</label>
                                <input type="text"  class="form-control input-lg" name="employer" required>
                            </div>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">City</label>
                                <input type="text"  class="form-control input-lg" name="jobcity" required>
                            </div>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">State</label>
                                <input type="text"  class="form-control input-lg" name="jobstate" required>
                            </div>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">Start Date</label>
                                <input type="text"  class="form-control input-lg" name="startdate9" required>
                            </div>
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">End Date</label>
                                <input type="text"  class="form-control input-lg" name="enddate9" required>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6"  style="text-align:justify;">
                                <label for="job-description">Percentage of Previous Semester</label>

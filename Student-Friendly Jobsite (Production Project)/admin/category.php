                    ...
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-sm" href="edit_cat.php?sid=<?php echo $row['category_id']; ?>">Edit
                                        <i class="fa fa-pencil"></i>                
                                    </a>	
                                    <a class="btn btn-danger btn-sm" href="delete_cat.php?sid=<?php echo $row['category_id']; ?>">Delete

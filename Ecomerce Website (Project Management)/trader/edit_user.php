...
if (isset($_POST['save'])){
  ...
  $dates = $_POST['dates'];
	...
	if($txtPass == $pass){
		...
		//$pass = md5($pass);
		$sql = "UPDATE USERS SET USER_FIRST_NAME = '$fname', USER_LAST_NAME='$lname', USER_ADDRESS = '$address',USER_PASSWORD='$pass', DATE_OF_BIRTH = '$dates', USER_IMAGE = '$folder'  WHERE USER_ID = '$USER_ID'";
	}	
...
<div class="content-wrapper">      
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Trader Profile</li>
      </ol>
    </section>
    <!-- Main content -->

            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="firstname" name="firstname" value="<?php echo $user['USER_FIRST_NAME']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo $user['USER_LAST_NAME']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="contact" name="contact" value="<?php echo $user['USER_ADDRESS']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="address" name="address"><?php echo $user['USER_ADDRESS']; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-12">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Current password to save changes" required>
                    </div>
                </div>
            </div>
